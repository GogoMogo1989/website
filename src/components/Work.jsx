...
<SwiperSlide>
          ...
          <SwiperSlide>
            ...
            <div className="p-2 mt-2 ">
              ...
              <div className="pt-1">
                <p className="text-sm text-gray-400">
                The page was created using MERN (MongoDb-Express-React-Node) technology. The site is a fictitious pizzeria website where the user can order, with or without registration. The site includes an admin interface where orders can be managed or new products can be added, edited or deleted. If you are curious about the admin page <span><a href="https://bestpizzakfd.netlify.app/adminlogin">(https://bestpizzakfd.netlify.app/adminlogin)</a></span>, you can register. Secretkey: Silverland2024.
                </p>
              </div>
              <div className="pt-1">
